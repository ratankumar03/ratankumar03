...
<p align="center">
 Kolkata, India |  MCA Graduate |  Open to Opportunities
</p>
...
I specialize in **Python, Django, Machine Learning**, and modern web technologies. With a strong foundation in data structures, algorithms, and system design, I build efficient and maintainable software solutions.
...
###  [Intrusion Detection System](https://github.com/ratankumar03/intrusion-detection-system)
...
###  [3D Car Racing Game](https://github.com/ratankumar03/car-racing-game-backend)
...
**Tech Stack:** `Django REST Framework` `React` `Three.js` `WebGL` `PostgreSQL`
...
**Tech Stack:** `Django` `Machine Learning` `NLP` `spaCy` `REST API` `React`
...
-  **Open Source Contributor** to various Python and Django projects
